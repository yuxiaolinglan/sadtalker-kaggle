...
class AnimateFromCoeff():
    ...
    def generate(self, x, video_save_dir, pic_path, crop_info, enhancer=None, up_scale=2,background_enhancer=None, preprocess='crop', img_size=256):
        ...
        if enhancer:
            ...
            try:
                enhanced_images_gen_with_len = enhancer_generator_with_len(full_video_path, method=enhancer, bg_upsampler=background_enhancer, up_scale=up_scale)
                imageio.mimsave(enhanced_path, enhanced_images_gen_with_len, fps=float(25))
            except:
                enhanced_images_gen_with_len = enhancer_list(full_video_path, method=enhancer, bg_upsampler=background_enhancer, up_scale=up_scale)
                imageio.mimsave(enhanced_path, enhanced_images_gen_with_len, fps=float(25))
